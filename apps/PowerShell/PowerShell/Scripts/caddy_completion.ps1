        ...
        switch ($Mode) {
            ...
            "Complete" {
                ...
                if ($Values.Length -eq 1) {
                    ...
                    [System.Management.Automation.CompletionResult]::new($($comp.Name | __caddy_escapeStringWithSpecialChars) + $Space, "$($comp.Name)", 'ParameterValue', "$($comp.Description)")
            ...
            Default {
                ...
                [System.Management.Automation.CompletionResult]::new($($comp.Name | __caddy_escapeStringWithSpecialChars), "$($comp.Name)", 'ParameterValue', "$($comp.Description)")
            }
        }
